...
function [sys,x0,str,ts] = CD1_sfun_cso__B_controllable(t,x,u,flag,Vmax,n_comp,n_sed,tstep)
...
% u(1) = Qemax
% u(2) = Q inflow
% u(3..n+1) = Component concentration in inflow
...
switch flag,
  ...
  case 2,
    Qemax = u(1); %TODO: bring those in the functions??
    u = u(2:end);
